...
<div id='navigation' className='flex flex-wrap mt-6'>
    ...
    switch (selectedNavigation) {
        ...
        case "Deals":
          ...
          return dealsBooks.slice(0,9).map((book,index) => (
              <BookElement 
              id={book.id}
              image={book.image?book.image:"https://drupal.nypl.org/sites-drupal/default/files/blogs/J5LVHEL.jpg"}
              title={book.title} 
        ...
        case "New releases in fiction":
          ...
          return newReleasedFictionBooks.slice(0,9).map((book,index) => (
              <BookElement 
              id={book.id}
              image={book.image?book.image:"https://drupal.nypl.org/sites-drupal/default/files/blogs/J5LVHEL.jpg"}
              title={book.title} 
          ...
          return newReleasedEducation.slice(0,9).map((book,index) => (
              <BookElement 
              id={book.id}
              image={book.image?book.image:"https://drupal.nypl.org/sites-drupal/default/files/blogs/J5LVHEL.jpg"}
              title={book.title} 
          ...
          case "Top Free":
            ...
            return freeBooks.map((book,index) => (
                <BookElement 
                id={book.id}
                image={book.image?book.image:"https://drupal.nypl.org/sites-drupal/default/files/blogs/J5LVHEL.jpg"}
                title={book.title} 
